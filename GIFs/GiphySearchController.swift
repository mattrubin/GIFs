...
class GiphySearchController {
    ...
    func search(for query: String) {
        ...
        let searchOperation = GiphyCore.shared.search(query, limit: pageSize) { [weak self] (response, error) in
            ...
            // confimed by checking that the current search-in-progress has the expected query string, and by checking
            // that the search operation is in a finished state.
